...
export default function EquipmentSales() {
  ...
  const mockProducts = [
    { id: 1, name: "A-dec 500 Dental Chair", category: "Chairs", description: "Premium comfort and access with integrated delivery system.", features: ["Ultra-thin backrest", "Pressure mapping comfort", "Integrated touchpad"], imageUrl: "/images/dental-chair.jpg" },
    { id: 2, name: "Planmeca ProMax 3D", category: "Imaging", description: "All-in-one CBCT unit including 3D imaging, 3D photo, digital 2D panoramics.", features: ["SCARA technology", "Face photo", "Endodontic mode"], imageUrl: "/images/dental-imaging.jpg" },
    { id: 3, name: "Midmark M11 UltraClave", category: "Sterilization", description: "Automatic opening door for efficient instrument drying.", features: ["Large chamber", "Steam-flush", "LCD display"], imageUrl: "/images/sterilizer.jpg" },
    { id: 4, name: "AirStar 30 Compressor", category: "Mechanical", description: "Oil-free dental air compressor for up to 4 users.", features: ["100% oil-free", "Membrane dryer", "Compact design"], imageUrl: "/images/vacuum-system.jpg" },
    { id: 5, name: "Pelton & Crane Helios", category: "Lighting", description: "LED operatory light with exceptional brightness and color accuracy.", features: ["No-touch sensor", "Cool operation", "Crisp white light"], imageUrl: "/images/dental-light.jpg" },
